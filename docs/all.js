...
! function(t, e) {
  ...
  var v = function() {
      ...
      return o(e, [{
        ...
        value: function(t, e) {
          if (d(t))
            for (let n = 0; n < t.length; n++) this.on(t[n], e);
        ...
        value: function(t, e) {
          if (d(t))
            for (let n = 0; n < t.length; n++) this.emit(t[n], e);
      ...
      return o(n, [{
        ...
        value: function() {
          ...
          return this._e.emit('mount.before'), c(t) && (this._c = function(t, e, n) {
            var i = {};
            for (let r in e) l(e[r]) && (i[r] = e[r](t, i, n));
            for (let o in i) l(i[o].mount) && i[o].mount();
            return i;
  ...
  var H = function() {
    ...
    return o(e, [{
      ...
      value: function(t, e, n) {
        ...
        u(t) && (t = [t]);
        for (let r = 0; r < t.length; r++) this.listeners[t[r]] = n, e.addEventListener(t[r], this.listeners[t[r]], i);
      },
    }, {
      key: 'off',
      value: function(t, e) {
        ...
        u(t) && (t = [t]);
        for (let i = 0; i < t.length; i++) e.removeEventListener(t[i], this.listeners[t[i]], n);
      },
    }, {
      key: 'destroy',
      value: function() {
    ...
    var s = [function(e, n) {
      ...
      return {
        modify: function(t) {
          var e = s.Gaps.value;
                        var n = s.Sizes.width;
                        var i = o.settings.focusAt;
                        var r = s.Sizes.slideWidth;
  ...
  var M = e;
        ...
        var P = ["touchmove", "mousemove"];
        var L = ["touchend", "touchcancel", "mouseup", "mouseleave"];
        var z = ['mousedown', 'mousemove', 'mouseup', 'mouseleave'];
  var j = '[data-glide-el="controls[nav]"]';
        var D = '[data-glide-el^="controls"]';
  ...
  var R = {
    ...
    Clones: function(h, v, t) {
      var e = {
        ...
        remove: function() {
          for (let t = this.items, e = 0; e < t.length; e++) v.Html.wrapper.removeChild(t[e]);
        },
      };
      return p(e, 'grow', {
        get: function() {
          ...
          move: function(t) {
            ...
            if (!d.disabled) {
              var e = d.settings;
                                ...
                                var i = this.threshold(t);
                                var r = n.pageX - m;
                                var o = 180 * p / Math.PI;
                                var s = Math.round(r / h.Sizes.slideWidth);
